# Microsoft Developer Studio Project File - Name="arrayer" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Standard Graphics Application" 0x0108

CFG=arrayer - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "arrayer.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "arrayer.mak" CFG="arrayer - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "arrayer - Win32 Release" (based on "Win32 (x86) Standard Graphics Application")
!MESSAGE "arrayer - Win32 Debug" (based on "Win32 (x86) Standard Graphics Application")
!MESSAGE 
...
!ELSEIF  "$(CFG)" == "arrayer - Win32 Debug"
...
# Name "arrayer - Win32 Release"
# Name "arrayer - Win32 Debug"
